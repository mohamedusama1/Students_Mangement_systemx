...
class StudentsClass:
    def __init__(self, root):
        ...
        date_lbl = Label(up_frame, font=('courier', 18, 'bold'),
                         bg='#F6F5F5', fg='#DA7297')
        ...
        CTkButton(head_frame, text='FIRST GRADE\nMIDDLE SCHOOL',
                  width=300, height=200, fg_color='#DA7297', text_color='white',
                  bg_color='#F6F5F5', border_spacing=20, hover_color='#DA7297',
                  border_width=5, image=img, compound='top',
                  font=('arial', 22, 'bold'), border_color='#D8D2C2',
        ...
        if session.can("add_student"):
            CTkButton(head_frame,
                      ...
                      font=('arial', 13, 'bold'), border_color='#2e7d32',
                      hover_color='#1b5e20', border_width=2, corner_radius=15,
                      command=open_import_page).place(x=930, y=510)
        else:
            Label(head_frame, text="🔒 Import — admin/superadmin only",
                  bg='#F6F5F5', fg='#aaaaaa',
